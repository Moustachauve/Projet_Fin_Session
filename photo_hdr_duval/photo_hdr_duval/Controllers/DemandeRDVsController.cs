...
namespace photo_hdr_duval.Controllers
{
    public class DemandeRDVsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RDVID,DateRDV,HeureRDV,Commentaire,NomProprietaire,PrenomProprietaire,TelPrincipalProprietaire,TelSecondaire,AdressePropriete,EmailProprietaire,ForfaitID,Ville,DateDemande")] RDV rDV)
        {
            if (ModelState.IsValid)
            {
